        ...
        <div className={styles.columnContainer}>
          <div className={styles.leftColumn}>
            <h2 className={styles.footerTitle}>
              This a catchy line to engage!
            </h2>
            <p className={styles.footerText}>
              Iusto corporis harum odit provident cupiditate, consequatur
              mollitia sequi veritatis perferendis dolore repellendus repellat
              error architecto doloremque aliquid blanditiis culpa quo facere.
            </p>
